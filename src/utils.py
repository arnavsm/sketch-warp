...
def setup_logger(model_name: str, logging_dir) -> Logger:
    """
...
def save_metrics_report(report: Dict, model_name: str, epoch: int, save_dir: str):
    """
...
def count_model_flops_params(model: nn.Module, input_size=(3, 224, 224), print_results=True):
    """
