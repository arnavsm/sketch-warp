...
class Sequential(nn.Sequential):
    ...
    def forward(self, *args):
        ...
        for module in self._modules.values():
            if isinstance(module, (BasicBlock, Bottleneck, Sequential, CondBatchNorm2d, CustomResNet)):
                x = module(x, cond)
            else:
                x = module(x)
        return x
...
def resnet18(pretrained: str = "", progress: bool = True, **kwargs: Any) -> CustomResNet:
...
def resnet34(pretrained: str = "", progress: bool = True, **kwargs: Any) -> CustomResNet:
...
def resnet50(pretrained: str = "", progress: bool = True, **kwargs: Any) -> CustomResNet:
...
def resnet101(pretrained: str = "", progress: bool = True, **kwargs: Any) -> CustomResNet:
...
def resnet152(pretrained: str = "", progress: bool = True, **kwargs: Any) -> CustomResNet:
